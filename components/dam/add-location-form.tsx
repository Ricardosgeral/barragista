...
interface AddDamLocationFormProps {
  ...
  damId: string | null;
  damLocation: DamLocation | null; //if null will create a dam
}
...
export default function AddDamLocationForm({
  ...
  const handleDeleteLocation = (damId: string, damLocation: DamLocation) => {
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                          onClick={() =>
                            handleDeleteLocation(damId, damLocation)
                          }
                        >
                          Continue
                        </AlertDialogAction>
